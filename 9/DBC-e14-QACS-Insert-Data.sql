...
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Desk', TO_DATE('11/07/14', 'MM/DD/YY'), 1800.00, 3000.00, 2);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Desk Chair', TO_DATE('11/10/14', 'MM/DD/YY'), 300.00, 500.00, 4);
  
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Dining Table Linens', TO_DATE('11/14/14', 'MM/DD/YY'), 600.00, 1000.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Candles', TO_DATE('11/14/14', 'MM/DD/YY'), 30.00, 50.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Candles', TO_DATE('11/14/14', 'MM/DD/YY'), 27.00, 45.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Desk Lamp', TO_DATE('11/14/14', 'MM/DD/YY'), 150.00, 250.00,  3);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Dining Table Linens', TO_DATE('11/14/14', 'MM/DD/YY'), 450.00, 750.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Book Shelf', TO_DATE('11/21/14', 'MM/DD/YY'), 150.00, 250.00, 5);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Chair', TO_DATE('11/21/14', 'MM/DD/YY'), 750.00, 1250.00, 6);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Chair', TO_DATE('11/21/14', 'MM/DD/YY'), 1050.00, 1750.00, 6);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Candle Holders', TO_DATE('11/28/14', 'MM/DD/YY'), 210.00, 350.00, 2);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Desk', TO_DATE('01/05/15', 'MM/DD/YY'), 1920.00, 3200.00, 2);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Desk', TO_DATE('01/05/15', 'MM/DD/YY'), 2100.00, 3500.00, 2);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Desk Chair', TO_DATE('01/06/15', 'MM/DD/YY'), 285.00, 475.00, 9);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Desk Chair', TO_DATE('01/06/15', 'MM/DD/YY'), 339.00, 565.00, 9);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Desk Lamp', TO_DATE('01/06/15', 'MM/DD/YY'), 150.00, 250.00, 10);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Desk Lamp', TO_DATE('01/06/15', 'MM/DD/YY'), 150.00, 250.00, 10);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Desk Lamp', TO_DATE('01/06/15', 'MM/DD/YY'), 144.00, 240.00, 3);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Dining Table', TO_DATE('01/10/15', 'MM/DD/YY'), 3000.00, 5000.00, 7);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Antique Sideboard', TO_DATE('01/11/15', 'MM/DD/YY'), 2700.00, 4500.00, 8);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Dining Table Chairs', TO_DATE('01/11/15', 'MM/DD/YY'), 5100.00, 8500.00, 9);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Dining Table Linens', TO_DATE('01/12/15', 'MM/DD/YY'), 450.00, 750.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Dining Table Linens', TO_DATE('01/12/15', 'MM/DD/YY'), 480.00, 800.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Candles', TO_DATE('01/17/15', 'MM/DD/YY'), 30.00, 50.00, 1);
INSERT INTO ITEM VALUES(seqIID.NextVal,
	'Candles', TO_DATE('01/17/15', 'MM/DD/YY'), 36.00, 60.00, 1);
COMMIT;  
...
INSERT INTO SALE VALUES(seqSID.NextVal,
  1, 1, TO_DATE('12/14/14', 'MM/DD/YY'), 3500.00, 290.50, 3790.50);
  
INSERT INTO SALE VALUES(seqSID.NextVal,
  2, 1, TO_DATE('12/15/14', 'MM/DD/YY'), 100.00, 83.00, 1083.00);
INSERT INTO SALE VALUES(seqSID.NextVal,
  3, 1, TO_DATE('12/15/14', 'MM/DD/YY'), 50.00, 4.15, 54.15);
INSERT INTO SALE VALUES(seqSID.NextVal,
  4, 3, TO_DATE('12/23/14', 'MM/DD/YY'), 45.00, 3.74, 48.74);
INSERT INTO SALE VALUES(seqSID.NextVal,
  1, 5, TO_DATE('01/05/15', 'MM/DD/YY'), 250.00, 20.75, 270.75);
INSERT INTO SALE VALUES(seqSID.NextVal,
  5, 5,	TO_DATE('01/10/15', 'MM/DD/YY'), 750.00, 62.25, 812.25);
INSERT INTO SALE VALUES(seqSID.NextVal,
  6, 4, TO_DATE('01/12/15', 'MM/DD/YY'), 250.00, 20.75, 270.75);
INSERT INTO SALE VALUES(seqSID.NextVal,
  2, 1, TO_DATE('01/15/15', 'MM/DD/YY'), 3000.00, 249.00, 3249.00);
INSERT INTO SALE VALUES(seqSID.NextVal,
  5, 5, TO_DATE('01/25/15', 'MM/DD/YY'), 350.00, 29.05, 379.05);
INSERT INTO SALE VALUES(seqSID.NextVal,
  7, 1, TO_DATE('02/04/15', 'MM/DD/YY'), 14250.00, 1182.75, 15432.75);
INSERT INTO SALE VALUES(seqSID.NextVal,
  8, 5, TO_DATE('02/04/15', 'MM/DD/YY'), 250.00, 20.75, 270.75);
INSERT INTO SALE VALUES(seqSID.NextVal,
  5, 4, TO_DATE('02/07/15', 'MM/DD/YY'), 50.00, 4.15, 54.15);
INSERT INTO SALE VALUES(seqSID.NextVal,
  9, 2, TO_DATE('02/07/15', 'MM/DD/YY'), 4500.00, 373.50, 4873.50);
INSERT INTO SALE VALUES(seqSID.NextVal,
  10,	3, TO_DATE('02/11/15', 'MM/DD/YY'), 3675.00, 305.03, 3980.03);
INSERT INTO SALE VALUES(seqSID.NextVal,
  2, 2, TO_DATE('02/11/15', 'MM/DD/YY'), 800.00, 66.40, 866.40);
